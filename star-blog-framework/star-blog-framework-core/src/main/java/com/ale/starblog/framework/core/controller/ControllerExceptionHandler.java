...
public class ControllerExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @NonNull
    @Override
    protected ResponseEntity<Object> handleMissingPathVariable(MissingPathVariableException ex, @NonNull HttpHeaders headers, @NonNull HttpStatusCode status, @NonNull WebRequest request) {
    ...
    @NonNull
    @Override
    protected ResponseEntity<Object> handleMissingServletRequestPart(MissingServletRequestPartException ex, @NonNull HttpHeaders headers, @NonNull HttpStatusCode status, @NonNull WebRequest request) {
    ...
    @NonNull
    @Override
    protected ResponseEntity<Object> handleServletRequestBindingException(ServletRequestBindingException ex, @NonNull HttpHeaders headers, @NonNull HttpStatusCode status, @NonNull WebRequest request) {
    ...
    @NonNull
    @Override
    protected ResponseEntity<Object> handleConversionNotSupported(ConversionNotSupportedException ex, @NonNull HttpHeaders headers, @NonNull HttpStatusCode status, @NonNull WebRequest request) {
        log.warn("参数转换异常，无法将类型为[{}]的参数[{}]转为指定的类型[{}]", ex.getValue() == null ? StringConstants.NULL : ex.getValue().getClass().getName(), ex.getPropertyName(), ex.getRequiredType());
    ...
    protected ResponseEntity<Object> handleTypeMismatch(TypeMismatchException ex, @NonNull HttpHeaders headers, @NonNull HttpStatusCode status, @NonNull WebRequest request) {
        log.warn("参数类型不匹配，参数[{}]要求的类型为[{}]，实际类型为：[{}]", ex.getPropertyName(), ex.getRequiredType(), ex.getValue() == null ? StringConstants.NULL : ex.getValue().getClass().getName());
    ...
    @NonNull
    @Override
    protected ResponseEntity<Object> handleHttpMessageNotWritable(HttpMessageNotWritableException ex, @NonNull HttpHeaders headers, @NonNull HttpStatusCode status, @NonNull WebRequest request) {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, @NonNull HttpHeaders headers, @NonNull HttpStatusCode status, @NonNull WebRequest request) {
        ...
        if (bindingResult.hasFieldErrors() && bindingResult.getTarget() != null) {
            ...
            return this.response(headers, "参数校验不通过：" + bindingResult.getAllErrors().get(0).getDefaultMessage());
        }
    }
     ...
     */
    @Override
    protected ResponseEntity<Object> handleAsyncRequestTimeoutException(AsyncRequestTimeoutException ex, @NonNull HttpHeaders headers, @NonNull HttpStatusCode status, @NonNull WebRequest webRequest) {
