...
public class SystemConfigController extends BaseController<SystemConfig, SystemConfigService, SystemConfigVO, SystemConfigBO, SystemConfigQuery, CreateSystemConfigDTO, ModifySystemConfigDTO> {
}