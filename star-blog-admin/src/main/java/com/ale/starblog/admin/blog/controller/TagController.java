...
import com.ale.starblog.admin.blog.service.TagService;
...
public class TagController extends BaseController<Tag, TagService, TagVO, TagBO, TagQuery, CreateTagDTO, ModifyTagDTO> {
